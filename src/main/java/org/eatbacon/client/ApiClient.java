...
import org.eatbacon.StringUtil;
import org.eatbacon.client.auth.Authentication;
import org.eatbacon.client.auth.HttpBasicAuth;
import org.eatbacon.client.auth.ApiKeyAuth;
import org.eatbacon.client.auth.OAuth;

@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-01-22T13:03:56.676-08:00")
public class ApiClient {
  private Map<String, Client> hostMap = new HashMap<String, Client>();
  private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  private boolean debugging = false;
  private String basePath = "https://localhost:8080/v1";
